...
An offline first app for managing patients, it allows health care providers to register patients and collect vital signs (including height, weight, and BMI) then syncs the information to the backend.
## Screenshots
<table>
  <tr>
    <th>Login</th>
